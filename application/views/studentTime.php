            ...
            <div class="col">
             <div class="btn-group">
                    ...
                    <li><a class="dropdown-item" href="<?php echo site_url()?>/Ojt">Student's Company Info</a></li>
                        <li><a class="dropdown-item" href="<?php echo site_url()?>/Ojt">Student's Weekly Report</a></li>
        ...
        <div class="col-2">
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    ...
                    <th scope="col">DTR Image</th>
                    <th scope="col">Date</th>
                    <th scope="col">Time In</th>
                    <th scope="col">Time Out</th>   
                    <th scope="col">Hours Earned</th>  
                    <th scope="col">Supervisor's Name/Signature</th>
                    <th scope="col">Total Hourse Rendered</th>  
                ...
                <?php foreach ($addressbook as $row): ?>
                            ...
                            <td><?php echo $row->studentNumber; ?></td>
                                ...
                                <td> <img src="<?php echo base_url().'assets/uploads/'.$row->dtrImage;?>" height="150" width="150" class="img-fluid" alt="dtr"></td>
                                ...
                                <td></td>
                                <td><?php echo $row->totalHours; ?></td>
                                <td><?php echo 500-$row->totalHours; ?></td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
        </table></div>
