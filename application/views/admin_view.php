...
<body>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-2"></div>
                <div class="col-10" ><h1> Profile</h1></div>
                <div class="d-flex justify-content-center">
                
                <img src="<?=base_url().'assets/uploads/'.$row->image;?>" height="150" width="150" class="img-fluid" alt="person">
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="name" value="<?php echo $row->firstName; ?> <?php echo $row->lastName; ?>" class="form-control" placeholder="" aria-label="Name" aria-describedby="basic-addon1">
                            </div>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="text" value="<?php echo $row->email; ?>" class="form-control" placeholder="" aria-label="Email" aria-describedby="basic-addon1">
                            </div>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="text"  value="<?php echo $row->username; ?>"  class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="password"  value="<?php echo $row->password; ?>"  class="form-control" placeholder="" aria-label="Password" aria-describedby="basic-addon1">
                            </div>
                ...
                <div class="container"><div class="row">
                        ...
                        <div class="col"></div>
                        <div class="col-5">
                        <a type="button" class="btn btn-primary btn-sm" href="<?php echo site_url('Admin/edit');?>/<?php echo $row->username;?>/<?php echo $row->contactNumber;?>">Update Info</a>
                        </div>
