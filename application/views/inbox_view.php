...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-10">
            <h1>Inbox</h1>
            <span><i>Select the names to reveal and hide the messages</i></span>
        </div>
        </div>
        ...
        <br>
            ...
            <div class="col-2"></div>
            <div class="col-10">
                <a data-toggle="collapse" href="#<?= $row->rciID?>" role="button" aria-expanded="false" aria-controls="collapseExample">
                <p class="text-left text-white bg-secondary"><?php echo $row->firstName; ?> <?php echo $row->lastName; ?></p>
                </a>
                <div class="collapse" id="<?= $row->rciID?>">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                <p class="card-text"><?php echo $row->userTypeName; ?></p>
                                <p class="card-text">Student Number: <?php echo $row->studentNumber;?> </p>
                                <p class="card-text">Contact No.: <?php echo $row->contactNumber;?>  </p>
                                <p class="card-text"> Section : <?php echo $row->section; ?></p>
                                </div>

                                <div class="card-footer text-muted">
                                <?php echo $row->rciDateTime; ?>
                                </div>
                                
                                </div>
                                <div class="d-flex justify-content-end">
                                <a href="<?php echo site_url('Inbox/takeAction');?>/<?php echo $row->rciID;?>" class="btn btn-primary btn-sm">Done</a>     
                                <a href="<?php echo site_url('Inbox/takeAction');?>/<?php echo $row->rciID;?>" class="btn btn-outline-secondary btn-sm">Ignore</a>
