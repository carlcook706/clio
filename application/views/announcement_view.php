...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="btn-group">
                    ...
                    <?php foreach($result2 as $row1) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Announcement/sectionPick');?>/<?php echo $row1->sectionID;?>"><?php echo $row1->section;?></a></li>
                        <?php } ?>
                    </ul>
                    </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-5">
            <a href="#exampleModal1" class="btn btn-outline-secondary btn-sm" data-toggle="modal" role="button" data-target="#exampleModal1">Make Announcement</a>
             </div>
        </div>
    <br>
    <br>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo site_url('Announcement/create') ?>">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Feature</label>
                        <input type="text" class="form-control" name="feature" aria-describedby="emailHelp" placeholder="Enter feature">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Topic</label>
                        <input type="text" class="form-control" name="topic" aria-describedby="emailHelp" placeholder="Enter topic">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Announcement</label>
                        <input type="text" class="form-control" name="announcement" aria-describedby="emailHelp" placeholder="Enter announcement">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputEmail1">Section</label>
                ...
                <?php foreach($result as $row) {?>
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-header">
                            <?= $row->announcementFeature?>
                        </div>

                        <div class="card-body">
                        <h5 class="card-title"> <?= $row->announcementTopic?></h5>
                        ...
                        <a href="<?php echo site_url('Announcement/edit');?>/<?php echo $row->announcementID;?>" class="btn btn-outline-secondary btn-sm">Edit</a>

                        <a href="<?php echo site_url('Announcement/delete');?>/<?php echo $row->announcementID;?>" class="btn btn-primary btn-sm">Delete</a>           
                        </div>
                        </div>
                        <br>
                <?php } ?>
