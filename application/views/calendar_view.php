...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="btn-group">
                    ...
                    <?php foreach($result2 as $row) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Calendar/batchPick');?>/<?php echo $row->batchID;?>"><?php echo $row->batchName;?></a></li>
                        <?php } ?>
                    </ul>
                    </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-5">
            <button type="button" data-toggle="modal" class="btn btn-outline-secondary btn-sm" data-target="#exampleModal1">Add To Do</button>
                </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo site_url('Calendar/create') ?>">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Activity</label>
                        <input type="text" class="form-control" name="activity" aria-describedby="emailHelp" placeholder="Enter activity">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Expected Output</label>
                        <input type="text" class="form-control" name="expectedOutput" aria-describedby="emailHelp" placeholder="Enter expected output">
                    </div>
                    <div class="form-group">
                    ...
                    <?php foreach($result2 as $row) {?>
                        <option value="<?php echo $row->batchID;?>"><?php echo $row->batchID;?></option>
                        <?php } ?>
                    </select>
                    </div>
        ...
        <div class="col-2">
            ...
            <tbody>
                ...
                <tr>
                <td scope="row"><?php echo $row->activity; ?></td>
                <td><?php echo $row->expectation; ?></td>
                <td><?php echo $row->calendarDateTime;?></td>
                <td> <a href="<?php echo site_url('Calendar/edit');?>/<?php echo $row->calendarID;?>" class="btn btn-outline-secondary btn-sm">Edit</a>  | 
                   <a class="btn btn-primary btn-sm" href="<?php echo site_url('Calendar/delete');?>/<?php echo $row->calendarID;?>">Delete</a> </td>
                </tr>
                <?php } ?>
            </tbody>
        </table></div>
