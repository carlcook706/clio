...
<body>
    ...
    <div class="container">
        ...
        <h1> Master List </h1>
            ...
            <label for="exampleInputEmail1">Section:</label>
                    ...
                    <?php foreach($section as $row2) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Master_list/sectionPick');?>/<?php echo $row->batchID;?>/<?php echo $row2->sectionID;?>"><?php echo $row2->section;?></a></li>
                        <?php } ?>
                    </ul>
                    </div>
            </div>
            ...
            <label for="exampleInputEmail1">Batch:</label>
             <div class="btn-group">
                    ...
                    <?php foreach($batch as $row1) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Master_list/batchPick');?>/<?php echo $row1->batchID;?>/<?php echo $row->sectionID;?>"><?php echo $row1->batchName;?></a></li>
                        <?php } ?>
        ...
        <div class="col-2">
            ...
            <div class="col-10">
            <div class="table table-responsive"><table class="table text-center  table-bordered table-striped">
            <?php if (isset($error)): ?>
            ...
            <div class="col-2">
                ...
                <h6> <i>Upload Master List from CSV File:</i></h6>
                        <form method="post" action="<?php echo site_url() ?>/Master_list/importcsv" enctype="multipart/form-data">
